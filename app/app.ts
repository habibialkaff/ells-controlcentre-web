...
app.run(['$route', 'authService', function ($route: ng.route.IRoute, authService: Ells.AuthService) {
...
app.config(['$locationProvider', '$routeProvider', 'routes', function ($locationProvider: ng.ILocationProvider, $routeProvider: ng.route.IRouteProvider, routes: Ells.IRouteConstant[]) {
...
app.filter('nfcurrency', [
    '$filter', '$locale', function ($filter: ng.IFilterService, $locale: ng.ILocaleService) {
